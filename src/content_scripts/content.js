...
if (!window.elementInspector) {
    ...
    function throttle(fn, delay) {
        ...
        return function(...args) {
            ...
            if (now - lastCall < delay) {
                // Using a direct console.log here as `_log` is part of the class, and this throttle
                // is outside, but the message itself is informative for debugging performance.
                console.log("[ElementInspector] Throttling mousemove event, skipping execution.");
                return;
            }
    ...
    class ElementInspector {
        constructor() {
            // Internal flag to control console logging. Set to `false` for production to suppress all logs.
        ...
        _log(message, data) {
            if (this._debugMode) {
                if (data !== undefined) {
                    console.log(`[ElementInspector] ${message}`, data);
                } else {
                    console.log(`[ElementInspector] ${message}`);
                }
            }
        }
