class SettingsManager {
  ...
  log(message, ...args) {
    if (this.debugMode) {
      console.log(`[SettingsManager] ${message}`, ...args);
    }
  }
  ...
  async fetchDropdownData() {
    try {
      ...
      console.error("[SettingsManager] Error fetching dropdown data. Please ensure 'src/data/dropdown-data.json' exists and is declared in 'web_accessible_resources' in manifest.json:", error);
